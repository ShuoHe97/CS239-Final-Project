...
// Rigid terrain
RigidTerrain::Type terrain_model = RigidTerrain::MESH;
...
int main(int argc, char* argv[]) {
    ...
    switch (terrain_model) {
        ...
        case RigidTerrain::MESH:
            ...
            // std::string vis_file = "/home/asher/ContinentalMapping/Processed/export_02/park_street_col.obj";
            // // std::string vis_file = "/home/asher/ContinentalMapping/Processed/export_02/park_street_vis.obj";
            // auto vis_mesh = std::make_shared<ChTriangleMeshConnected>();
            // vis_mesh->LoadWavefrontMesh(vis_file, false, true);
            // vis_mesh->Transform(ChVector<>(0, 0, 0), ChMatrix33<>(1));  // scale to a different size
            // // vis_mesh->RepairDuplicateVertexes(1e-9);
            //
            // //
            // auto ground_body = std::make_shared<ChBody>();
            // // ground_body->SetMass(1000);
            // // ground_body->SetInertiaXX(ChVector<>(10, 10, 10));
            ...
            // my_hmmwv.GetSystem()->Add(ground_body);
            // masset_mesh->SetMesh(vis_mesh);
            // ground_body->AddAsset(masset_mesh);
            // break;
            break;
    }
