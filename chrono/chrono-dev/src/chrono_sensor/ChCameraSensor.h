...
namespace chrono {
namespace sensor {
class CH_SENSOR_API ChCameraSensor : public ChSensor, public IRendersWithOptix {
  public:
    ChCameraSensor(std::shared_ptr<chrono::ChBody> parent,
                   double updateRate,
                   ...
                   float hFOV,
                   float vFOV,
                   ProgramString program = {"camera", "pinhole_camera"},
                   RTformat buffer_format = RT_FORMAT_UNSIGNED_BYTE4);
    ~ChCameraSensor();
